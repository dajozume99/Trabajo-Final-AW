...
<div class="container marketing">
	<form name="formulari1" method="get" action="eliminar2.php">
      <div class="form-group">
      <label for="nom">Código del equipo</label>
      <input type="nom" class="form-control" placeholder="Codigo de equipo" name="codi">
       </div>
